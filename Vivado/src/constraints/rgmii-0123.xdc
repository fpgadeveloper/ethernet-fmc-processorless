...
set_input_delay -clock [get_clocks *temac_0/inst_rgmii_rx_clk] -max -1.4 [get_ports -of [get_nets -of [get_pins "*/temac_0/rgmii_rxd[*] */temac_0/rgmii_rx_ctl"]]]
...
set_input_delay -clock [get_clocks *temac_0/inst_rgmii_rx_clk] -clock_fall -max -1.4 -add_delay [get_ports -of [get_nets -of [get_pins "*/temac_0/rgmii_rxd[*] */temac_0/rgmii_rx_ctl"]]]
...
set_input_delay -clock [get_clocks *temac_1/inst_rgmii_rx_clk] -max -1.4 [get_ports -of [get_nets -of [get_pins "*/temac_1/rgmii_rxd[*] */temac_1/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *temac_1/inst_rgmii_rx_clk] -min -2.8 [get_ports -of [get_nets -of [get_pins "*/temac_1/rgmii_rxd[*] */temac_1/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *temac_1/inst_rgmii_rx_clk] -clock_fall -max -1.4 -add_delay [get_ports -of [get_nets -of [get_pins "*/temac_1/rgmii_rxd[*] */temac_1/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *temac_1/inst_rgmii_rx_clk] -clock_fall -min -2.8 -add_delay [get_ports -of [get_nets -of [get_pins "*/temac_1/rgmii_rxd[*] */temac_1/rgmii_rx_ctl"]]]

set_input_delay -clock [get_clocks *temac_2/inst_rgmii_rx_clk] -max -1.4 [get_ports -of [get_nets -of [get_pins "*/temac_2/rgmii_rxd[*] */temac_2/rgmii_rx_ctl"]]]
...
set_input_delay -clock [get_clocks *temac_2/inst_rgmii_rx_clk] -clock_fall -max -1.4 -add_delay [get_ports -of [get_nets -of [get_pins "*/temac_2/rgmii_rxd[*] */temac_2/rgmii_rx_ctl"]]]
...
set_input_delay -clock [get_clocks *temac_3/inst_rgmii_rx_clk] -max -1.4 [get_ports -of [get_nets -of [get_pins "*/temac_3/rgmii_rxd[*] */temac_3/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *temac_3/inst_rgmii_rx_clk] -min -2.8 [get_ports -of [get_nets -of [get_pins "*/temac_3/rgmii_rxd[*] */temac_3/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *temac_3/inst_rgmii_rx_clk] -clock_fall -max -1.4 -add_delay [get_ports -of [get_nets -of [get_pins "*/temac_3/rgmii_rxd[*] */temac_3/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *temac_3/inst_rgmii_rx_clk] -clock_fall -min -2.8 -add_delay [get_ports -of [get_nets -of [get_pins "*/temac_3/rgmii_rxd[*] */temac_3/rgmii_rx_ctl"]]]
