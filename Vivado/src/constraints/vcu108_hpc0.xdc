...
set_property PACKAGE_PIN BE9 [get_ports mdio_io_port_0_io]
set_property PACKAGE_PIN BF14 [get_ports {rgmii_port_1_rd[2]}]
set_property PACKAGE_PIN BB13 [get_ports {ref_clk_fsel[0]}]
set_property PACKAGE_PIN BB12 [get_ports mdio_io_port_1_io]
...
set_property PACKAGE_PIN AM12 [get_ports mdio_io_port_2_io]
...
set_property PACKAGE_PIN AU11 [get_ports mdio_io_port_3_io]
set_property PACKAGE_PIN AV11 [get_ports reset_port_3]

# Global reset (CPU_RESET pushbutton)
set_property PACKAGE_PIN E36      [get_ports glbl_rst]
...
set_property PACKAGE_PIN AV36     [get_ports activity_flash_2]
set_property PACKAGE_PIN AY35     [get_ports frame_error_3]
...
# NORTH:  reset_error
# EAST:   NOT USED
set_property PACKAGE_PIN AW27     [get_ports update_speed]
set_property PACKAGE_PIN M22     [get_ports config_board]
set_property PACKAGE_PIN D9      [get_ports pause_req_s]
set_property PACKAGE_PIN E34     [get_ports reset_error]
#set_property PACKAGE_PIN A10     [get_ports NOT_USED]
set_property IOSTANDARD  LVCMOS12 [get_ports update_speed]
set_property IOSTANDARD  LVCMOS12 [get_ports config_board]
set_property IOSTANDARD  LVCMOS12 [get_ports pause_req_s]
set_property IOSTANDARD  LVCMOS12 [get_ports reset_error]
